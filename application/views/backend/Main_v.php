...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <div id="logo-mobile" class="visible-xs">
                   <h1 color:="" ff0000="" font:="" id="textDestination" margin:="" style="background-color: transparent;  color: white; text-shadow: 1px 1px 2px white, 0 0 25px white, 0 0 10px white; font-family: Impact;"><font color="white" size="4"> <a href="<?php echo base_url("backend/home"); ?>">PT.PAYUNG ANAK BANGSA</a></font>
               <!--  <span>v1.0</span> -->
            </h1>
                </div>
    ...
    <div id="skin-select">
        <div id="logo">
           <h1 color:="" ff0000="" font:="" id="textDestination" margin:="" style="background-color: transparent;  color: white; text-shadow: 1px 1px 2px white, 0 0 25px white, 0 0 10px white; font-family: Impact;"><font size="4" color="white" > <a href="<?php echo base_url("backend/home"); ?>">PT.PAYUNG ANAK BANGSA</a></font>
               <!--  <span>v1.0</span> -->
            </h1>
        </div>
                    ...
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <ul>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="<?php echo base_url("backend/category_gallery/cek"); ?>" title="Category Portfolio"><i class="icon-media-record"></i><span>Category Portfolio </span></a>
                                </li>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="<?php echo base_url("backend/gallery/cek"); ?>" title="Sub Page"><i class="entypo-clock"></i><span>Portfolio</span></a>
                                </li>
                            </ul>
                        </li>
             ...
             <div class="col-sm-12"> 
                ...
                <div id="footer">
                    ...
                    <div class="copyright">Make with Love
                        <span class="entypo-heart"></span> Payung Anak Bangsa v1.0 © PAB v1.0 Development Team <?php echo date('Y'); ?></a> All Rights Reserved</div>
